 ...
 */
export function satisfiesMinVersion(cliVersion, minVersion) {
    if (minVersion === null)
        return true; // no lower gate (a deliberate null = long-stable).
    ...
    if (cli === null)
        return false; // fail-closed: gated, but version unknown/unparseable.
