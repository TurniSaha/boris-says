 ...
 */
const SENTENCE_LEAD_WORDS: readonly string[] = [
 ...
 */
export function completesYouve(habit: string): boolean {
  ...
  if (SENTENCE_LEAD_WORDS.includes(firstWord)) return false;
  const lower = trimmed.toLowerCase();
  if (lower.includes('the developer') || lower.includes('the user')) return false;
  return true;
}
 ...
 */
function withTerminalPeriod(fix: string): string {
